...
public class BlogsController {
    ...
    @PutMapping("/{blogPostId}/uploadCover")
    public Blogpost uploadCover(@PathVariable int blogPostId, @RequestParam("file") MultipartFile file) {

        String url = cloudinaryService.uploadFile(file);


        Blogpost updatedBlogpost = blogsService.updateCover(blogPostId, url);
